(function() {
    ...
    function stateConfig($stateProvider) {
        ...
        .state('referral-source-detail', {
            ...
            resolve: {
                entity: ['$stateParams', 'ReferralSource', function($stateParams, ReferralSource) {
                    return ReferralSource.get({id : $stateParams.id}).$promise;
                }],
                previousState: ["$state", function ($state) {
                    var currentStateData = {
                        name: $state.current.name || 'referral-source',
                        params: $state.params,
        ...
        .state('referral-source-detail.edit', {
            parent: 'referral-source-detail',
            url: '/detail/edit',
            data: {
                authorities: ['ROLE_USER']
            },
        ...
        .state('referral-source.new', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    ...
                    $state.go('referral-source', null, { reload: 'referral-source' });
                }, function() {
