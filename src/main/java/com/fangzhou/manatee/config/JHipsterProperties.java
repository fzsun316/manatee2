...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "manatee@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "manatee API";

        private String description = "manatee API documentation";
