...
public class Queue extends AbstractAuditingEntity implements Serializable {
    ...
    public Queue status(String status) {
        this.status = status;
        return this;
    }
    ...
    public Queue timestampInitial(ZonedDateTime timestampInitial) {
    ...
    public Queue timestampFinal(ZonedDateTime timestampFinal) {
    ...
    public Queue patient(Patient patient) {
