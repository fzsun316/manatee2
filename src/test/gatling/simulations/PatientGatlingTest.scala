...
class PatientGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Patient entity")
        ...
        .repeat(2) {
            ...
            .post("/api/patients")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "medicalReferralID":"SAMPLE_TEXT", "age":null, "conditionDesciption":"SAMPLE_TEXT", "priority":"SAMPLE_TEXT", "deadline":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
